...
# 15 min — multi-pass generation runs past the old 5-min cap.
...
GEMINI_IMAGE_SIZE=${GEMINI_IMAGE_SIZE:-1K}
CLAUDE_SOCIAL_MODEL=${CLAUDE_SOCIAL_MODEL:-}
SOCIAL_POST_PRICE_FULA=${SOCIAL_POST_PRICE_FULA:-300}
MAX_CONCURRENT_SOCIAL_JOBS=${MAX_CONCURRENT_SOCIAL_JOBS:-2}
SOCIAL_JOB_TIMEOUT_MS=${SOCIAL_JOB_TIMEOUT_MS:-300000}
MAX_SOCIAL_JOBS_PER_USER_PER_HOUR=${MAX_SOCIAL_JOBS_PER_USER_PER_HOUR:-10}
SOCIAL_MAX_REFERENCE_IMAGES=${SOCIAL_MAX_REFERENCE_IMAGES:-8}
SOCIAL_ASSETS_BUCKET=${SOCIAL_ASSETS_BUCKET:-website-assets}
