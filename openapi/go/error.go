...
// Returns errors in IPFS standard Failure format.
func DefaultErrorHandler(w http.ResponseWriter, _ *http.Request, err error, result *ImplResponse) {
	...
	// Handle all other errors - check if result already contains a Failure object
	if result != nil && result.Body != nil {
		if _, ok := result.Body.(Failure); ok {
			// Already a Failure object, encode as-is
