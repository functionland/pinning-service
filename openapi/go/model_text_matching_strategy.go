...
// AllowedTextMatchingStrategyEnumValues is all the allowed values of TextMatchingStrategy enum
...
// validTextMatchingStrategyEnumValue provides a map of TextMatchingStrategys for fast verification of use input
var validTextMatchingStrategyEnumValues = map[TextMatchingStrategy]struct{}{
	"exact": {},
	"iexact": {},
	"partial": {},
	"ipartial": {},
...
func (v TextMatchingStrategy) IsValid() bool {
	_, ok := validTextMatchingStrategyEnumValues[v]
	return ok
}
...
func NewTextMatchingStrategyFromValue(v string) (TextMatchingStrategy, error) {
	...
	return "", fmt.Errorf("invalid value '%v' for TextMatchingStrategy: valid values are %v", v, AllowedTextMatchingStrategyEnumValues)
}
...
// AssertTextMatchingStrategyConstraints checks if the values respects the defined constraints
func AssertTextMatchingStrategyConstraints(obj TextMatchingStrategy) error {
	return nil
}
