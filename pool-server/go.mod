...
replace github.com/functionland/pinning-service => ../openapi/go

go 1.22.1

require (
	github.com/elazarl/goproxy v0.0.0-20240618083138-03be62527ccb
	github.com/functionland/pinning-service v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/ipfs-cluster/ipfs-cluster v1.1.1 // indirect
