/**
 * Database Schema for x402-skale Gateway
 *
...
CREATE TABLE IF NOT EXISTS x402_payment_logs (
  ...
  amount_usdc REAL NOT NULL,                -- Amount in USDC (human readable)
  ...
  size_mb REAL,                             -- Object size in MB
...
CREATE TABLE IF NOT EXISTS x402_ephemeral_objects (
  ...
  size_bytes INTEGER NOT NULL,              -- Object size in bytes
  size_mb REAL NOT NULL,                    -- Object size in MB
  payment_id TEXT,                          -- Link to payment log
  expires_at DATETIME NOT NULL,             -- When to delete
